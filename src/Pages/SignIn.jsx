...
export default function SignIn() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#F8FAF5] via-white to-[#F8FAF5] p-4 md:p-6 relative overflow-hidden">
      ...
      {showResetModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[999] flex items-center justify-center p-4 animate-fade-up" style={{ animationDuration: '0.2s' }}>
          <div className="bg-white rounded-2xl p-8 max-w-md w-full shadow-2xl animate-scale-in" style={{ animationDuration: '0.3s' }}>
            {!resetSent ? (
              <>
                <div className="text-center mb-6">
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-nature-green mb-2">Check your inbox!</h3>
                <p className="text-gray-500 text-sm mb-6">We sent a password reset link to <strong>{resetEmail}</strong></p>
                <button
                  onClick={() => {
                    setShowResetModal(false);
                    setResetSent(false);
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-between pt-1">
                  ...
                  <button
                    ...
                    className="text-sm text-primary font-semibold hover:text-primary-dark transition-colors cursor-pointer relative z-20"
                  >
                    Forgot Password?
                  </button>
                </div>
